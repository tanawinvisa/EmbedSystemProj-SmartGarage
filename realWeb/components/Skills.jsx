...
import STM from '../public/assets/skills/stm.png';
  ...
  return (
    <div id='skills' className='w-screen lg:h-screen p-2'>
      <div className='max-w-[1240px] w-4/5 mx-auto flex flex-col justify-center h-full'>
        ...
        <h2 className='py-4'>What did we learn and also use in this project</h2>
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src={Arduino} width='64px' height='64px' alt='/' />
              </div>
              <div className='flex flex-col items-center justify-center'>
                <h3>Arduino</h3>
              </div>
          ...
          <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src={STM} width='64px' height='64px' alt='/' />
              </div>
              <div className='flex flex-col items-center justify-center'>
                <h3>STM32</h3>
              </div>
